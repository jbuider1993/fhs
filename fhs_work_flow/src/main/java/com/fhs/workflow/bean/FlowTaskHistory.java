...
public class FlowTaskHistory extends BaseDO<FlowTaskHistory> {
    ...
    public FlowTaskHistory(String id, String instanceId, String taskFinishTime, String taskId, String candidateUserId, String candidateRuleId, Integer status, String title, String parentTaskId, Integer useTime, String assigneeUserId, Integer result, String remark) {
        this.id = id;
