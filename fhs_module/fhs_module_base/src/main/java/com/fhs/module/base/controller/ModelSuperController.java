 ...
 *
 */
public class ModelSuperController<V extends VO ,D extends BaseDO> extends BaseController
{
    private static final Logger LOG = Logger.getLogger(ModelSuperController.class);
    ...
    public void exportExcel(HttpServletRequest request, HttpServletResponse response){
        /*
           ...
           6  从poi获取二进制 下载
         */
        List<V> dataList = getExportData(request);
     ...
     * @param response response
     */
    protected  void exportExcel(List<V> dataList,HttpServletRequest request, HttpServletResponse response)
    {
     ...
     * @return 需要导出的数据
     */
    private List<V> getExportData(HttpServletRequest request){
    ...
    public HttpResult add(@Validated(Add.class) V e, BindingResult check, HttpServletRequest request,
    ...
    public HttpResult update(@Validated(Update.class) V e, BindingResult check, HttpServletRequest request,
                             HttpServletResponse response)
    {
    ...
    public void findListData(V e, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        if (isPermitted(request, "see"))
        {
