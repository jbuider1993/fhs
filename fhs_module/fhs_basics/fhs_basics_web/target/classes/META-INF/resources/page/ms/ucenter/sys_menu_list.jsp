...
<script type="text/javascript">
	...
	//添加菜单
	function addMenu() {
		parent.openMenuAddOrUpdate('${basePath}/b/page-ms-ucenter/sys_menu_add_update?isEdit=false&parentId=${param.menuId}&menuType=${menuType}','添加菜单');
	}

	//修改菜单
	function updateMenu(row) {
		parent.openMenuAddOrUpdate('${basePath}/b/page-ms-ucenter/sys_menu_add_update?isEdit=true&parentId=${param.menuId}&menuType=${menuType}&id='+row.menuId,'修改菜单');
	}
