...
<script type="text/javascript">
     ...
     */
    function addUser() {
        openDialog('${basePath}page/ms/basics/sys_user_add_update.jsp?organizationId=${param.organizationId}&isAdd=true', '添加用户');
    }
     ...
     */
    function update(row) {
        openDialog('${basePath}page/ms/basics/sys_user_add_update.jsp?isEdit=true&id=' + row.userId, '修改用户');
    }
     ...
     */
    function view(row) {
        openDialog('${basePath}page/ms/basics/sys_user_add_update.jsp?isView=true&id='+row.userId, '查看用户');
    }
