...
<script type="text/javascript">
     ...
     */
    function add() {
        openDialog('${basePath}page/ms/basics/sys_system_add_update.jsp', '添加');
    }
    var id = '${param.id}';
     ...
     */
    function update(row) {
        openDialog('${basePath}page/ms/basics/sys_system_add_update.jsp?isEdit=true&id=' + row.id, '修改');
    }
    /**
     * 查看
     */
    function view(row) {
        openDialog('${basePath}page/ms/basics/sys_system_add_update.jsp?isView=true&id=' + row.id, '查看');
    }
    //重新加载
    function reload() {
