...
<script type="text/javascript">
	...
	function addMenu() {
		...
		openDialog(
				'${basePath}page/ms/basics/sys_menu_permission_add_update.jsp?isEdit=false&parentId=${param.menuId}',
				"添加");
	}
	...
	function updateMenu(row) {
		openDialog(
				'${basePath}page/ms/basics/sys_menu_permission_add_update.jsp?isEdit=true&parentId=${param.menuId}&permissionId='
						+ row.permissionId, "编辑");
