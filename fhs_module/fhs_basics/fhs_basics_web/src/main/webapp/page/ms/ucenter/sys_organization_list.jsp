...
<script type="text/javascript">
    ...
    function addMenu() {
        ...
        openDialog(
            '${basePath}page/ms/ucenter/sys_organization_add_update.jsp?parentId='+parentId,
            '添加机构');
    }
    ...
    function updateMenu(pkField) {
        openDialog(
            '${basePath}page/ms/ucenter/sys_organization_add_update.jsp?isEdit=true&id=' + pkField, "修改机构");
    }
