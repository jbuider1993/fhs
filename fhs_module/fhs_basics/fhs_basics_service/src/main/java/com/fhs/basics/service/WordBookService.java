 ...
 * @since  [产品/模块版本]
 */
public interface WordBookService extends BaseService<WordbookVO, WordbookDO>
{
     ...
     * @return 字典集合
     */
    List<WordbookVO> getWordBookList(String wordbookGroupCode);
     ...
     */
    void initWordBookDataCache(WordbookDO bean);
