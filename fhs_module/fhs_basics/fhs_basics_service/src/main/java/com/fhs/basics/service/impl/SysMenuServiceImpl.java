...
public class SysMenuServiceImpl extends BaseServiceImpl<SysMenuVO, SysMenuDO> implements SysMenuService, FeignSysMenuApiService {
    ...
    @Autowired
    private SysMenuPermissionMapper adminMenuButtonMapper;
    ...
    public List<TreeDataVO> findMenuTreeToJson(Integer menuType, String groupCode) {
        ...
        list.add(0, root);
        List<SysMenuPermissionDO> buttons = adminMenuButtonMapper.findForListFromMap(new HashMap<>());
        // 标记哪些按钮id属于哪些菜单
        Map<String, Set<Integer>> buttonMap = new HashMap<>();
        Set<Integer> buttonTypeSet = null;
        for (SysMenuPermissionDO button : buttons) {
    ...
    public List<TreeDataVO> findMenuTreeToJson(String menuType) {
        ...
        List<SysMenuPermissionDO> buttons = adminMenuButtonMapper.findForListFromMap(new HashMap<String, Object>());
    ...
    @Override
    public boolean deleteButton(SysMenuDO menu) {
        return mapper.deleteButton(menu) > ZERO;
    }

    @Override
    public boolean delete(SysMenuDO bean) {
        deleteButton(bean);
    ...
    @Override
    public boolean updateDisable(SysMenuDO menu) {
        try {
    ...
    @Override
    public boolean update(SysMenuDO bean) {
