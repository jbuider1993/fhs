 ...
 */
public interface UcenterMsOrganizationService extends BaseService<UcenterMsOrganizationVO, UcenterMsOrganizationDO> {
     ...
     * @return 是否成功
     */
    boolean insertOrganization(UcenterMsOrganizationDO adminOrganization);
     ...
     * @return 是否存在
     */
    boolean validataOrgName(UcenterMsOrganizationDO sysOrganization);
