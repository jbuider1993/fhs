...
public class MsMenuController extends ModelSuperController<SysMenuVO,SysMenuDO>
{
    ...
    @ResponseBody
    public HttpResult addMenu(HttpServletRequest request, HttpServletResponse response, SysMenuDO adminMenu)
    {
        try
        {
    ...
    public void getBeanData(HttpServletRequest request, HttpServletResponse reponse, SysMenuDO adminMenu)
    {
        SysMenuVO bean = sysMenuService.findBean(adminMenu);
    ...
    @ResponseBody
    public HttpResult updateMenu(HttpServletRequest request, HttpServletResponse reponse, SysMenuDO adminMenu)
    {
        try
        {
            String url = adminMenu.getMenuUrl();
    ...
    public void listData(HttpServletRequest request, HttpServletResponse reponse, SysMenuDO adminMenu)
    {
        ...
        List<SysMenuVO> dataList = sysMenuService.findForListFromMap(map);
    ...
    public void findMenuRootTrees(HttpServletRequest request, HttpServletResponse reponse, SysMenuDO adminMenu)
    {
        Integer menuType = 0;// 平台菜单
        List<TreeDataVO> treeList = sysMenuService.findMenuTreeToJson(menuType,super.getSessionuser(request).getGroupCode());
    ...
    public void findMenuParkTrees(HttpServletRequest request, HttpServletResponse reponse, SysMenuDO adminMenu)
    {
    ...
    public void searchServer(HttpServletRequest request, HttpServletResponse reponse, SysMenuDO adminMenu)
    {
