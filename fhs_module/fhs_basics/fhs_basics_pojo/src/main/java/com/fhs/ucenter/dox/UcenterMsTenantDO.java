...
public class UcenterMsTenantDO extends BaseDO<UcenterMsTenantDO> {
    ...
    public UcenterMsTenantDO() {
    }

    public UcenterMsTenantDO(String groupCode, String id, String tenantName, String contacts, String mobile, String logo, String remark, String email, String systemIds) {
