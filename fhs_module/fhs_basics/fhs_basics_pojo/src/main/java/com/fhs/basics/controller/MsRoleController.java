...
public class MsRoleController extends ModelSuperController<SysRoleVO, SysRoleDO>
{
    ...
    Logger LOG = Logger.getLogger(MsRoleController.class);
    ...
    public void getBeanData(HttpServletRequest request, HttpServletResponse reponse, SysRoleDO sysRole)
    {
        SysRoleVO bean = sysRoleService.findBean(sysRole);
    ...
    public void searchButtons(HttpServletRequest request, HttpServletResponse response, SysRoleDO sysRole)
    {
    ...
    public void getCurrentOrganizationSysRoles(HttpServletRequest request, HttpServletResponse response) {
        //获取当前登录用户
        SysUserVO sysUser = (SysUserVO) request.getSession().getAttribute(Constant.SESSION_USER);
        SysRoleDO sysRole = new SysRoleDO();
        List<SysRoleVO> sysRoleList = sysRoleService.findForList(sysRole);
    ...
    public void realRoleComBoxData(HttpServletRequest request, HttpServletResponse response, SysRoleDO sysRole)
    {
        Map<String, Object> map = super.getPageTurnNum(request);
    ...
    public HttpResult updateSysRole(HttpServletRequest request, HttpServletResponse response, SysRoleDO sysRole)
    {
    ...
    public HttpResult add(HttpServletRequest request, HttpServletResponse response, SysRoleDO sysRole)
    {
        try
        {
            SysUserVO sysUser = super.getSessionuser(request);
    ...
    @ResponseBody
    public HttpResult del(HttpServletRequest request, HttpServletResponse response, SysRoleDO sysRole)
    {
        try
        {
