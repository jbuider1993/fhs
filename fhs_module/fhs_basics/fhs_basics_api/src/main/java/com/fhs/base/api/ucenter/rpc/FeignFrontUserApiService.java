...
public interface FeignFrontUserApiService {
     ...
     * @return 用户信息
     */
    @RequestLine("POST /api/com.fhs.base.api.ucenter.rpc.FeignFrontUserApiService/getSingleFrontUser")
     ...
     * @return 是否修改成功
     */
    @RequestLine("POST /api/com.fhs.base.api.ucenter.rpc.FeignFrontUserApiService/update")
     ...
     * @return 是否添加成功
     */
    @RequestLine("POST /api/com.fhs.base.api.ucenter.rpc.FeignFrontUserApiService/add")
     ...
     * @return 用户vo
     */
    @RequestLine("POST /api/com.fhs.base.api.ucenter.rpc.FeignFrontUserApiService/find")
