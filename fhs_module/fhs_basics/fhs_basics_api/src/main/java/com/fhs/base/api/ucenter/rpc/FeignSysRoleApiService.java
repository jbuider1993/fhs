...
public interface FeignSysRoleApiService {
     ...
     */
    @RequestLine("GET /api/com.fhs.base.api.ucenter.rpc.FeignSysRoleApiService/getRoleListPermissions?userId={userId}")
     ...
     */
    @RequestLine("GET /api/com.fhs.base.api.ucenter.rpc.FeignSysRoleApiService/getRoleById?id={id}")
