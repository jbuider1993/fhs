...
import com.fhs.publics.utils.ThumbnailatorUtils;
...
public class DownLoadController extends ModelSuperController<ServiceFileVO, ServiceFileDO> {
    ...
    public void download(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            // 文件下载路径
            ServiceFileVO serviceFile = serviceFileService.selectById(fileId);
    ...
    public void listData(HttpServletRequest request, HttpServletResponse response) {
        ...
        List<ServiceFileVO> list = serviceFileService.findForListFromMap(param);
    ...
    @ResponseBody
    public ServiceFileVO obtainFileNameById(HttpServletRequest request) {
        String fileId = request.getParameter("fileId");
        ServiceFileVO serviceFile = serviceFileService.selectById(fileId);
        return serviceFile;
    }
    ...
    public void downImgMin(HttpServletRequest request, HttpServletResponse response) {
        ...
        ServiceFileVO serviceFile = serviceFileService.findBeanFromMap(map);
        if (serviceFile == null) {
            return;
        }
     ...
     * @return
     */
    private  String[] getPngPathList(List<ServiceFileVO> serviceFile) {
        String token = null;
