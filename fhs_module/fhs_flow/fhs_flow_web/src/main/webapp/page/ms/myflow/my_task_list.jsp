...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<table id="voDataGrid" title="我的待办工作" class="easyui-datagrid" fit="true" style="width: 90%;" url="${basePath}myWorks/getNeedComplateTask.do" pagination="true" rownumbers="true" fitcolumns="true" singleselect="true" pagesize="10" toolbar="#toolbar">
			<thead>
				<tr>
		...
		<div id="toolbar">
			<div style="margin-bottom: 5px;">
			    ...
			    <a href="javascript:void(0)" class="easyui-linkbutton" iconcls="icon-edit" plain="true" onclick="addSelectRowFun('voDataGrid',handleTask);">处理</a>
		    </div>
		</div>
		<div id="addOrUpdateDialog" class="easyui-dialog" style="width: 80%; height: 80%; padding: 10px 20px"
		...
		<script>
			...
			function handleTask(row) {
				taskInfo = row;
				$('#dialogFrame').attr('src','${basePath}page/myworkflow/task_main_frame.jsp?processInstanceId=' + row.process_instance_id + '&taskId=' + row.ID_);
				$('#addOrUpdateDialog').dialog('open').dialog('setTitle', '处理工作:' + row.title + ':' + row.NAME_);
			}
