...
var t=$(_67);
return $.extend({},$.parser.parseOptions(_67,["cursor","page.ms.flow.handle","axis",{"revert":"boolean","deltaX":"number","deltaY":"number","edge":"number","delay":"number"}]),{disabled:(t.attr("disabled")?true:undefined)});
};
