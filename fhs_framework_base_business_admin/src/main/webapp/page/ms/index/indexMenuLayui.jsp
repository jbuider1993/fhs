	...
	<div class="layui-layout layui-layout-admin">
		...
		<div class="layui-side layui-side-menu">
			<div class="layui-side-scroll">
				<div class="layui-logo" >
					<img src="${basePath}/js/layui/layuiadmin/style/res/logo.png">
					<span>铭泊停车云管理系统</span>
				</div>
		...
		<div class="layadmin-pagetabs" id="LAY_app_tabs">
			...
			<div class="layui-tab" lay-unauto lay-allowClose="true" lay-filter="layadmin-layout-tabs">
				<ul class="layui-tab-title" id="LAY_app_tabsheader">
					<li lay-id="${pay_api_basePath}/page/ms/index/index_right.jsp" lay-attr="home/console.html" class="layui-this"><i class="layui-icon layui-icon-home"></i></li>
				</ul>
			</div>
		</div>
		...
		<div class="layui-body" id="LAY_app_body">
			<div class="layadmin-tabsbody-item layui-show">
				<iframe src="${pay_api_basePath}/page/ms/index/index_right.jsp" frameborder="0" class="layadmin-iframe"></iframe>
			</div>
		</div>
...
<script id="left_menu_teplate" type="text/html">
	...
	<li class="layui-nav-item" lay-unselect>
		...
		<@}@>
		  >
			<i class="layui-icon left-menu-icon" style="background-image:url(${fhs_file_basePath}/downLoad/file?fileId=<@=_temp_menu['image']@>)"></i>
