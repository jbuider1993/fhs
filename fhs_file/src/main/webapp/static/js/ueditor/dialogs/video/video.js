...
(function(){
    ...
    function createPreviewVideo(url){
        ...
        //var explorerType = window.navigator.userAgent.toLocaleLowerCase();
        //alter:h5流媒体标签 embed 对于浏览器兼容性不好这里暂时修改为video标签配置video.js使用替换
        var innerHtml = '<div class="previewMsg"><span>'+lang.urlError+'</span></div>' +
            ...
            '</embed>';
        //if (explorerType.indexOf("chrome") >= 0){//当前位谷歌浏览器
