...
<script type="text/javascript">
	 ...
	 */
	function add() {
		openDialog('${basePath}page/ms/ucenter/sys_server_add_update.jsp?id='+ id, '添加');
	}
	/**
	 * 修改
	 */
	function update(row) {
		openDialog('${basePath}page/ms/ucenter/sys_server_add_update.jsp?isEdit=true&id=' + row.id, '修改');
	}
	/**
	 * 查看
	 */
	function view(row) {
		openDialog('${basePath}page/ms/ucenter/sys_server_add_update.jsp?isView=true&id=' + row.id, '查看');
	}
	//重新加载
	function reload() {
