...
public class PageXAutoSqlService {
    ...
    public String autoInsert(PagexAddDTO pagexAddDTO)
    {
        ...
        sqlBuilder.append(",`create_time`,`create_user`,`update_time`,`update_user`)  VALUES ("
        ...
        sqlBuilder.append("DATE_FORMAT(NOW(),'%Y-%m-%d %H:%i:%S'),#{createUser},DATE_FORMAT(NOW(),'%Y-%m-%d %H:%i:%S'),#{updateUser})");
