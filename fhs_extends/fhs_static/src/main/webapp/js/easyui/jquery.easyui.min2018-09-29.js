...
$.fn.window.defaults=$.extend({},$.fn.panel.defaults,{zIndex:9000,draggable:true,resizable:true,shadow:true,modal:true,inline:false,title:"New Window",collapsible:true,minimizable:true,maximizable:true,closable:true,closed:false});
})(jQuery);
(function($){
function _279(_27a){
...
var cc=$(_308);
if(_309){
$.extend(opts,{width:40,height:_309.height});
}
cc._size(opts);
...
ul._outerWidth(wrap.width()).css("height","40px");
}else{
...
_3c9+=";width: 56px;text-align: center;height:" + el.style.height;
...
$('#jackToken').val(getCookie(referer));
//重写form提交添加 token校验 by wanglei  jackwang
var _4b3=$();
try{
for(var n in _4b2){
...
(function(){
if(_8ad.is(":visible")){
_8ad.panel("move",{left:_8ae(),top:_8af()+4});
setTimeout(arguments.callee,200);
}
})();
function _8ae(){
...
$.fn.combo.defaults=$.extend({},$.fn.textbox.defaults,{inputEvents:{click:_8a2,keyup:_8a6,paste:_8a6,drop:_8a6},panelWidth:165,panelHeight:200,panelMinWidth:null,panelMaxWidth:null,panelMinHeight:null,panelMaxHeight:null,panelAlign:"left",multiple:false,selectOnNavigation:true,separator:",",hasDownArrow:true,delay:200,keyHandler:{up:function(e){
},down:function(e){
},left:function(e){
},right:function(e){
},enter:function(e){
...
if(opts.showAll == true)
{
	...
	var newData = [allRow];
	$.each(_8f6.data,function(index,item)
	{
...
var _thisOptions = $.fn.combobox.parseOptions(this);
if(!_thisOptions.panelWidth){
	_thisOptions.panelWidth = 206;
}
if(_90d){
...
_90d=$.data(this,"combobox",{options:$.extend({},$.fn.combobox.defaults,_thisOptions,_90a),data:[]});
_906(this);
